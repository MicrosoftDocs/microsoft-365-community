...
PowerShell can also be used to manage Microsoft Entra Security Groups (https://learn.microsoft.com/en-us/entra/identity/users/groups-settings-v2-cmdlets)). This module does not work with .Net Core, so it requires a Windows PowerShell 5.x host.
