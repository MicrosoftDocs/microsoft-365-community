...
If you're looking for inspiration, a great place to look and even copy and paste code from community examples is the [PnP Column Samples](https://pnp.github.io/List-Formatting/columnsamples/) as well as the other resources below.
