---
title: Maturity Model for Microsoft 365 ‘«Ù People and Communities Competency
ms.date: 1/16/2026
author: eemancini
...
description: Maturity Model for Microsoft 365 ‘«Ù People and Communities Competency
ms.collection: M365Community
---

# Maturity Model for Microsoft 365 ‘«Ù People and Communities Competency
...
Within Microsoft 365, this means multiple individuals communicating across different channels (or as Microsoft sometimes calls them ‘«£loops‘«ÿ) to target their messaging or requests to the right people, in the right place, at the right time.
...
- People use ‘«£reply all‘«ÿ despite the impact this has in colleagues‘«÷ inboxes. Employees are unable to easily identify who-does-what in the organization, find subject matter experts, or understand the reporting structure. Requests for expertise and questions are often asked via email and then forwarded around the company until the correct subject matter expert is identified; minimal shared insights are created.
...
Systems may exist to support identifying who works in the organization and in which department. Distribution lists are used to communicate with groups such as ‘«£All Company‘«ÿ and each department. The processes to update information fall to IT, are essentially manual and undocumented, and lack formal processes to manage their members.
