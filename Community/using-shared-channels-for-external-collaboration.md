...
2. **Reused in multiple Teams in the same tenant** ([see this article for details](https://learn.microsoft.com/en-us/microsoft-365/community/using-shared-channels-for-external-collaboration)) so that users from multiple Teams can work together in the same space without needing access to the same Teams
