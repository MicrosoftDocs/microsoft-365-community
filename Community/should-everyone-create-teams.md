...
* The HTTP connector is a Premium conector and requires therefore a Power Automate Standalone Plan, [more info here](https://docs.microsoft.com/en-us/power-platform/admin/powerapps-flow-licensing-faq)
