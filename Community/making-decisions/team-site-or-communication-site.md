...
Most often, a communication site has a small number of people with permission to author content and many people who only have permission to read content. Team sites use Office 365 Groups for permissions. Communication sites use SharePoint groups.

**Think about your team sites as where you**  **collaborate**  **and your communications sites as where you**  **communicate****.**
...
| Who creates content? | Typically, same people create and read | Small number of editors, large number of readers |
| Security | Office 365 Groups OR SharePoint Groups (as of July 2018) | SharePoint Groups |
